    ...
    <section>
        ...
        <div class="navbar" id="navigation">
            <ul class="center-nav">
                ...
                <li onclick="page('StudentIssued.jsp','50px')" class="list">
                   <i class="fa-solid fa-book"></i>
                    <span class="title">Issued</span>
                </li>
                <li onclick="page('Student-staffHistory.jsp','100px')" class="list">
                ...
                <li class="list">
                    ...
                    <span class="title"></i><%=session.getAttribute("name") %></span>
                </li>
                <div class="anime"></div>
            </ul>
        </div>
