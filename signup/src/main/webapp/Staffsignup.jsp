...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>"> 
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="StaffsignupServlet" class="register-form"
							id="register-form">
					...
					<div class="signup-image">
						...
						<a href="Stafflogin.jsp" class="signup-image-link">I am already
							member</a>
					</div>
				</div>
			</div>
	...
	if(status == "success"){
	swal("Congrts","Account Created Successfully","success");
	}
